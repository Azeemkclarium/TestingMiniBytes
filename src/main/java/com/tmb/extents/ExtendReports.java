...
public final class ExtendReports {
	...
	public static void flushReport() throws IOException {
		...
		if (ReadPropertyFile.getvalue(PropertiesEnums.EMAILREPORT).equalsIgnoreCase("yes")) {
			EmailUtils.sendExtentReportViaEmail(FrameworkConstant.getExtentReportPath());
		} else {
			System.out.println("Email Report is Turned Off!");
		}
